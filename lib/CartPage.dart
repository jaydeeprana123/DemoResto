      ...
      appBar: AppBar(
        ...
        fontFamily: fontMulishBold,
            ...
            if(widget.showBilling)InkWell(onTap: ()async{
              ...
              children: [
                SvgPicture.asset(icon_cooking, width: 28, height: 28, color: Colors.black87,),
              ...
              children: [
                SvgPicture.asset(icon_bill, width: 24, height: 24, color: Colors.black87,),
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          SvgPicture.asset(icon_cooking, width: 32,color: Colors.white,),
